...
- 创建 `.gitignore`
- 初始化本地 Git 仓库
- 暂存并提交启动包文档、AI 提示词、README、老师要求文档、过程文件和项目级 Claude 配置
- 排除 `hotel_bookings.csv`、模型文件、数据输出目录和 `.claude` 配置备份文件

### 当前状态
- 已创建首个提交：`481eedb Initialize course project startup docs`
- Git 目前用于本地版本管理，暂未配置远程仓库

### 下一步建议
1. 如需多人协作，再创建 GitHub/Gitee 远程仓库。
2. 下一阶段先创建正式项目目录空文件夹。
3. 然后进入 A 的数据清洗、特征工程和模型训练。
